  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        <Copy style={{fontSize: 25, color: isDarkMode ? "gray" : "gray"}} value="-5" />
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <Copy style={{fontSize: 30, color: isDarkMode ? "gray" : "gray"}} value="-1" />
      </TouchableOpacity>

      <TextInput
        ref={inputRef}
        style={[styles.inputStyle, {color: isDarkMode ? 'lightgray' : 'gray'}]}
        value={
